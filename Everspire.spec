...
"""PyInstaller spec for the shippable Everspire build.
...
Build with:  backend\\venv\\Scripts\\pyinstaller Everspire.spec --noconfirm
...
exe = EXE(
    ...
    icon='assets/icon.ico',  # regenerate with: python tools/make_icon_painted.py flat_tower_bold
)
