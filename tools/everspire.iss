; Everspire installer (Inno Setup 6).
;
; Build:
...
;
; Produces release\Everspire-Setup.exe — one file, double-click, play.
;
; PER-USER INSTALL, ON PURPOSE. PrivilegesRequired=lowest puts the game in
; %LOCALAPPDATA%\Programs\Everspire, which means:
...
#define AppName        "Everspire"
#define AppVersion     "2026.07.30"
#define AppPublisher   "Liam Holloway"
#define AppExe         "Everspire.exe"
#define SrcDir         "..\release\Everspire"
...
OutputDir=..\release
OutputBaseFilename=Everspire-Setup
...
begin
  ...
  begin
    ...
    if DirExists(SavesDir) then
      MsgBox('Your Everspire saves and generated hero art were kept at:' + #13#10 + #13#10 +
